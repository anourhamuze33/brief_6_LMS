    ...
    <?php while ($section = $resultat->fetch_assoc()): ?>
        <div class="section-card">
            ...
            <div class="btn-container">
                <a href="index.php?section_action=update_Section&edit_section=<?= $section['id'] ?>&affich=<?= $id ?>" class="btn-edit-sec">
                ...
                <a href="index.php?section_action=delete_Section&delete_section=<?= $section['id'] ?>&affich=<?= $id ?>" class="btn-delete-sec">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
