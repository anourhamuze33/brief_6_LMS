...
<body>
    ...
    <div class="container">
        ...
        <div class="features-section">
            <h2><img src="../assets/goal.png" class="png"> Fonctionnalités principales <img src="../assets/goal2.png" class="png"></h2>
            
            <div class="features-grid">
                <div class="feature-card">
                    <div class="feature-icon"><img class="png" src="../assets/books-stack-of-three.png"></div>
                ...
                <div class="feature-card">
                    <div class="feature-icon"><img class="png" src="../assets/google-docs.png"></div>
                ...
                <div class="feature-card">
                    <div class="feature-icon"><img class="png" src="../assets/target.png"></div>
        ...
        <div class="cta-section">
            <h2><img class="png" src="../assets/high.png"> Commencez maintenant</h2>
